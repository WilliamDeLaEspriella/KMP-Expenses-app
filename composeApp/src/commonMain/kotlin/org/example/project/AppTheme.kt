...
fun getColorsTheme(): DarkModeColors {
    ...
    val ColorExpenseItem = if (isDarkMode) Color(0xFF090808) else Color(0xFFF1F1F1F1)
    var BackgroudColor =  if (isDarkMode) Color(0xFF1E1C1C) else Color.White
    var TextColor = if (isDarkMode) Color.White else Color.Black
    var AddIconColor = if (isDarkMode) Purple else Color.Black
    var ColorArrowRound = if (isDarkMode) Purple else Color.Gray.copy(alpha= .2f)
